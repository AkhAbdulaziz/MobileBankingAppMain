...
val servicesList: ArrayList<ServicesData> = arrayListOf(
    ServicesData(
        ...
        App.instance.getString(R.string.ru_services_title_payme_avia),
        App.instance.getString(R.string.ru_services_description_payme_avia)
    ),
    ServicesData(
        R.drawable.img_service2,
        App.instance.getString(R.string.ru_services_title_payment_for_checking_account),
        App.instance.getString(R.string.ru_services_description_payment_for_checking_account)
    ),
    ServicesData(
        R.drawable.img_service3,
        App.instance.getString(R.string.ru_services_title_iib_debt_checking),
        App.instance.getString(R.string.ru_services_description_iib_debt_checking)
    ),
    ServicesData(
        R.drawable.img_service4,
        App.instance.getString(R.string.ru_services_title_gold_crown),
        App.instance.getString(R.string.ru_services_description_gold_crown)
    ),
    ServicesData(
        R.drawable.img_service5,
        App.instance.getString(R.string.ru_services_title_payment_monitoring),
        App.instance.getString(R.string.ru_services_description_payment_monitoring)
    ),
    ServicesData(
        R.drawable.img_service6,
        App.instance.getString(R.string.ru_services_title_traffic_fine_notices),
        App.instance.getString(R.string.ru_services_description_traffic_fine_notices)
    ),
    ServicesData(
        R.drawable.img_service7,
        App.instance.getString(R.string.ru_services_title_auto_insurance),
        App.instance.getString(R.string.ru_services_description_auto_insurance)
    )
)
